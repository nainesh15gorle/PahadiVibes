...
export default function EditProductPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    async function loadData() {
      try {
        ...
        if (prodRes.success && prodRes.data) {
          ...
          setFeatured(p.featured === "TRUE" || p.featured === true);
          setBestSeller(p.bestSeller === "TRUE" || p.bestSeller === true);
          ...
          try {
            ...
            if (p.image) parsedImages = [p.image];
          }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("Save product submit error:", err);
  ...
  if (loading) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center min-h-[60vh]">
        ...
        <p className="mt-4 text-xs text-[#C8A951]/70 tracking-widest uppercase">Fetching masterpiece details...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 pb-16">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold font-heading text-white uppercase tracking-wider">Edit Product</h1>
          <p className="text-sm text-[#F5F5F5]/60 mt-1">Modify and update this premium Mandala Art masterpiece metadata.</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-[#1B1B1B] p-6 rounded-2xl border border-white/5 space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              />
              <p className="text-[10px] text-[#F5F5F5]/30">Slug for URLs and lookups.</p>
            </div>
          ...
          <div className="bg-[#1B1B1B]/40 p-4 rounded-2xl border border-white/5 flex flex-col gap-3">
            ...
            >
              {saving ? (
                ...
                <>
                  <Save className="w-4 h-4" /> Update Masterpiece
                </>
              )}
            </Button>
            <button
